 ...
 */
public class GetRouteTaskUtility extends FragmentActivity {
   ...
   //Method to parse the result String so as to get JSON format
    ...
    //Method to DrawPath the String generated in JSON format
