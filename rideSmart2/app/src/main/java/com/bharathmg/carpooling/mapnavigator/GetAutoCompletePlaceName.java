 ...
 */
public class GetAutoCompletePlaceName extends ArrayAdapter implements Filterable {
    ...
    public GetAutoCompletePlaceName(Context context, int textViewResourceId) {
