...
public class PostRideone  extends FragmentActivity implements LocationListener {
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> >{
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try{
                ...
                GetRouteTaskUtility.DirectionsJSONParser parser = new GetRouteTaskUtility.DirectionsJSONParser();
